...
public class TagCommandTest {
    ...
    @Test
    public void equals() {
        TagPredicate firstPredicate =
                new TagPredicate(Collections.singletonList("first"));
        TagPredicate secondPredicate =
                new TagPredicate(Collections.singletonList("second"));
    ...
    public void execute_multipleKeywords_multiplePersonsFound() {
        ...
        TagCommand command = prepareCommand("owesMoney family");
    ...
    private TagCommand prepareCommand(String userInput) {
        TagCommand command =
                new TagCommand(new TagPredicate(Arrays.asList(userInput.split("\\s+"))));
